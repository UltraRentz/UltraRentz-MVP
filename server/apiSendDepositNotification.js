...
router.post('/send-deposit-notification', async (req, res) => {
  ...
  const html = `<p>A new rent deposit has been <b>created and locked in escrow</b>.</p><ul><li><b>Escrow ID:</b> ${escrowId}</li><li><b>Amount:</b> ${amount}</li></ul><p>You are receiving this notification as a party or signatory to the agreement.</p>`;
  try {
