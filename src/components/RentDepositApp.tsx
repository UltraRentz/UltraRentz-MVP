          ...
          <div className={`main-container min-h-screen p-6 sm:p-8 md:p-10 w-full max-w-4xl mx-auto space-y-8 ${darkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-2">
              <div className="flex items-center" id="vault-intro">
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">UltraRentz – Protect. Grow. Resolve.</h1>
              </div>
            ...
            <DepositForm
              ...
              setPaymentStatus={(val: string) => updateState({ paymentStatus: val })}
              paymentTxHash={state.paymentTxHash}
              setPaymentTxHash={(val: string) => updateState({ paymentTxHash: val })}
